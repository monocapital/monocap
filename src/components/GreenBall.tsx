...
export default function GreenBall() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const element = document.querySelector('.green-ball-container');
      if (element) {
  ...
  return (
    <div
      className={`relative size-96 mx-auto transition-opacity duration-1000 ease-in-out green-ball-container ${isMounted ? '' : 'opacity-0'}`}
    >
